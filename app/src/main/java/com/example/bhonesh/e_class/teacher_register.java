...
public class teacher_register extends AppCompatActivity {
    ...
    private String id,sname,ssubject,sdepart,sq,spro,x,y,z;
    boolean a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ssubject=editsubject.getText().toString();
                sdepart=editdepart.getText().toString();
                sq=editq.getText().toString();
        ...
        saveb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                a=true;
                if(!ima){
                    Toast.makeText(teacher_register.this,"Please Upload image!",Toast.LENGTH_SHORT).show();
                    a=false;
                }
                ...
                final Firebase c_q=mref.child(id).child("q");
               ...
               check();
                ...
                if(a) {
                    ...
                    c_email.setValue(x);
                    c_password.setValue(y);
                    c_cpassword.setValue(z);
                    c_id.setValue(id);
                    c_subject.setValue(ssubject);
                    c_department.setValue(sdepart);
                    c_q.setValue(sq);
                    c_pro.setValue(spro);

                    final Firebase c_t = t_ref.child(spro).child(sdepart).child(sq).child(ssubject).child("Teacher");
    ...
    private void check() {
        ...
        if(ssubject.isEmpty()){
            editsubject.setHint("can't be empty");
            editsubject.setBackgroundColor(Color.parseColor("#FFEF767C"));a=false;
        }
        if(sdepart.isEmpty()){
        ...
        if(sq.isEmpty()){
            editq.setHint("can't be empty");
            editq.setBackgroundColor(Color.parseColor("#FFEF767C"));a=false;
        }
        if(spro.isEmpty()){
