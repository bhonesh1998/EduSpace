...
public class upload_assignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        up=(Button)findViewById(R.id.buttonUploadFile);

        //attaching listeners to views
       // findViewById(R.id.buttonUploadFile).setOnClickListener(upload_assignment.this);
//        findViewById(R.id.textViewUploads).setOnClickListener(upload_assignment.this);

        up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent=new Intent("com.example.bhonesh.e_class.upload_assignment");
